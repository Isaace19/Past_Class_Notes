...
int main()
{
    ...
    // don't technically have to call clear because the stack will automatically destroy the list after we're done.
    list.clear(); // even with calling new inside our class! This would still automatically be handled by the code.
